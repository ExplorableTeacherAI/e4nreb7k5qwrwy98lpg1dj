    ...
    <StackLayout key="layout-orient-promise" maxWidth="xl">
        <Block id="orient-promise" padding="sm">
            <EditableParagraph id="para-orient-promise" blockId="orient-promise">
                That question is what a derivative answers, and by the end of this you will be
                able to say exactly what it means and where it comes from. We start from nothing
                more than two points on a graph, so if you can read a point off a curve, you are
                ready to begin.
            </EditableParagraph>
        </Block>
    </StackLayout>,
