...
export const derivativeTwoPointsBlocks: ReactElement[] = [
    ...
    <StackLayout key="layout-two-points-setup" maxWidth="xl">
        <Block id="two-points-setup" padding="sm">
            <EditableParagraph id="para-two-points-setup" blockId="two-points-setup">Here is a phone battery draining across an evening. Drag the endpoints of the teal <InlineLinkedHighlight varName={"chordHighlight"} highlightId={"early"} color={"#2FA983"} bgColor={"rgba(98, 208, 173, 0.22)"} id={"linkedHighlight-1787153987434-7s2ag"}>early stretch</InlineLinkedHighlight> and the indigo <InlineLinkedHighlight varName={"chordHighlight"} highlightId={"late"} color={"#6366F1"} bgColor={"rgba(142, 144, 245, 0.22)"} id={"linkedHighlight-1787153987435-290d6"}>late stretch</InlineLinkedHighlight> along the curve, and compare what each one reports in percent per hour.  <InlineTooltip tooltip={"Tooltip content"} color={"#F59E0B"} bgColor={"rgba(245, 158, 11, 0.15)"} position={"auto"} maxWidth={400} id={"inlineTooltip-ceec38c6-48d7-434d-bd88-19e663ec7088"}>term</InlineTooltip></EditableParagraph>
        </Block>
    </StackLayout>,
