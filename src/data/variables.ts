...
export const variableDefinitions: Record<string, VariableDefinition> = {
    ...
    zoomWindow: {
        defaultValue: 0.8,
        type: 'number',
        label: 'Magnifier half width',
        description: 'Half the width in hours of the magnifier window around the 2 hour mark',
        unit: 'h',
        min: 0.15,
        max: 0.85,
        step: 0.05,
    ...
    zoomHighlight: {
        defaultValue: '',
        type: 'text',
        label: 'Zoom figure highlight',
        description: 'Which element is highlighted: tangent, window, or empty',
        color: '#2FA983',
        bgColor: 'rgba(98, 208, 173, 0.22)',
    },
    // Style-only definition: amber colours for the magnifier phrase.
    zoomHighlightWindowStyle: {
        defaultValue: '',
        type: 'text',
        label: 'Zoom figure highlight (magnifier styling)',
        description: 'Colour styling for the magnifier phrase',
        color: '#C77F0B',
        bgColor: 'rgba(247, 178, 59, 0.22)',
    },
    answer_instant_rate_slope: {
        defaultValue: '',
        type: 'select',
        label: 'Straightened slope',
        description: 'The slope of the line the curve becomes under magnification',
        placeholder: '???',
        correctAnswer: 'about -11 %/h',
        options: ['0 %/h', 'about -5 %/h', 'about -11 %/h'],
        color: '#AC8BF9',
    },
    answer_instant_rate_corner: {
        defaultValue: '',
        type: 'text',
        label: 'No straightening answer',
        description: 'What a graph has none of if zooming never straightens it',
        placeholder: '???',
